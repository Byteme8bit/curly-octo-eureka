...
def load_settings() -> Settings:
    ...
    def _yolo(aggressive: str, normal: str) -> str:
    ...
    fields: dict = dict(
        ...
        trade_size_pct=float(os.getenv("TRADE_SIZE_PCT", _yolo("0.15", _dt("0.20", "0.10")))),
        ...
        trade_cooldown_seconds=int(os.getenv("TRADE_COOLDOWN_SECONDS", _yolo("30", _dt("45", "180")))),
        max_trades_per_hour=int(os.getenv("MAX_TRADES_PER_HOUR", _yolo("30", _dt("40", "12")))),
        min_trade_edge=float(os.getenv("MIN_TRADE_EDGE", _yolo("0.002", _dt("0.004", "0.006")))),
