...
def _clean_recent_errors(
    ...
    The ``at`` field has the form ``"YYYY-MM-DD HH:MM:SS TZAbbr"``
    (e.g. ``"2026-05-31 08:02:59 PDT"``). Records with an unparseable
    timestamp are kept defensively.
    """
