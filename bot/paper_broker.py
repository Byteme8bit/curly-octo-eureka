...
class RiskState:
    ...
    def from_dict(cls, data: dict | None) -> "RiskState":
        ...
        # Clear paused_until when the pause window has already elapsed so
        # a restarted bot doesn't start in a spurious HIBERNATING state.
        ...
        # Reset trades_this_hour when the recorded window started more than
        # 1h ago so the rate limiter doesn't carry a stale count across restarts.
